    ...
    <div class="card-body">
        ...
        <form action="{{ route('trajets.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="duree_estimee" name="duree_estimee" value="{{ old('duree_estimee') }}" required>
            </div>

            <button type="submit" class="btn btn-success">Ajouter le Trajet</button>
